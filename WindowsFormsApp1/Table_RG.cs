...
{
    public partial class Table_RG : Form
    {
        public Table_RG()
        {
            InitializeComponent();
        ...
        private void Table_RG_Load(object sender, EventArgs e)
        {
            H.bs1 = new BindingSource();
            H.bs1.DataSource = H.myDT("SELECT * FROM Research_groups");
            ...
            dataGridView1.Columns[3].HeaderText = "Head of group";
